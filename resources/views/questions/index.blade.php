<x-guest-layout>
    ...
    <div class="grid gap-4 grid-cols-3">
        @foreach ($questions as $question)
            <div class="p-5 bg-gray-50 dark:bg-white-900 flex justify-between">
                <div class="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg max-w-lg">
                    <div class="flex mb-4">
                        ...
                        <div class="ml-2 mt-0.5">
                            <span class="block font-medium text-base leading-snug text-black dark:text-gray-100">{{ $question->title }}</span>
    ...
    <div class="py-5 mx-auto flex justify-center w-full align-center">
        {{ $questions->links() }}
    </div>
            ...
            @foreach ($questions as $question)
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3 class="p-2">{{ $question->title }}</h3>
                    </div>
                </div>
                <hr>
            @endforeach
